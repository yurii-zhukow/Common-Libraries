...
namespace YZ {
    ...
    public class LogStorage {
            ...
            try {
                ...
                for (var x = 0; x < 1000; x++)
                    try {
                        ...
                        curLogFilename = $"{dir}\\{n:yyyy-MM-dd HH-mm-ss} ({++x}).log";
                        continue;
                    }
            } catch {
                curLogStream = null;
        ...
        public static List<Item.Dto> GetItemsError(string err) => new List<Item.Dto> { new Item.Dto((byte)Verbosity.Error, 0, DateTime.Now.GetSecondId(), "Error", err) };
        ...
        public class Item {
            ...
            public struct Dto {
                ...
                public Dto(Item src) : this((byte)src.Verbosity, src.Index, src.Date.GetSecondId(), src.Prefix, src.Message) { }
